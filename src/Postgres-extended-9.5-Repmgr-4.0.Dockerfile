...
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/repmgr-common_4.0.6-2.pgdg80+1_all.deb" 
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/postgresql-$PG_MAJOR-repmgr_4.0.6-2.pgdg80+1_amd64.deb" 
