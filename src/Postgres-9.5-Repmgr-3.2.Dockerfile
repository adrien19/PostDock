...
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/repmgr-common_3.3.2-1.pgdg80+1_all.deb" 
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/postgresql-$PG_MAJOR-repmgr_3.3.2-1.pgdg80+1_amd64.deb" 
