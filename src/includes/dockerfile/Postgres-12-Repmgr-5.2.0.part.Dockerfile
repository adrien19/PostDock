...
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/repmgr-common_{{ REPMGR_PACKAGE_VERSION }}_all.deb" 
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/postgresql-$PG_MAJOR-repmgr_{{ REPMGR_PACKAGE_VERSION }}_amd64.deb" 
{{ /REPMGR_LATEST }}
